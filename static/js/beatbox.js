	...
	(function () {
	  ...
	  var ResultItem = (function (_React$Component) {
	    ...
	    function ResultItem() {
	      ...
	      _get(Object.getPrototypeOf(ResultItem.prototype), 'constructor', this).apply(this, arguments);
	    }
	    ...
	    _createClass(ResultItem, [{
	      ...
	      value: function render() {
	        return React.createElement(
	          ...
	          React.createElement(
	            'button',
	            { className: 'btn btn-default btn-xs', 'data-id': this.props.result.id, onClick: this.props.loadSound },
	            'Play'
	          )
	        );
	      }
	  ...
	  var ResultsList = (function (_React$Component2) {
	    ...
	    function ResultsList() {
	      ...
	      _get(Object.getPrototypeOf(ResultsList.prototype), 'constructor', this).apply(this, arguments);
	    }
	        ...
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            this.props.results.map(function (result) {
	              return React.createElement(ResultItem, { loadSound: _this.props.loadSound, result: result, key: result.id });
	            })
	          )
	        );
	      }
	      ...
	      value: function render() {
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'form',
	              { role: 'form', onSubmit: this.props.onSearch },
	              React.createElement(
	                'div',
	                { className: 'row' },
	                React.createElement(
	                  ...
	                  React.createElement('input', { className: 'form-control', type: 'text', id: 'search' }),
	                  React.createElement(
	                    'button',
	                    { role: 'button', className: 'btn btn-xs btn-primary' },
	                    'Search'
	                  )
	                )
	              )
	  ...
	  var BeatBox = (function (_React$Component4) {
	    _inherits(BeatBox, _React$Component4);

	    function BeatBox(props) {
	      _classCallCheck(this, BeatBox);

	      _get(Object.getPrototypeOf(BeatBox.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(BeatBox, [{
	      ...
	      key: 'onLoadSoundSuccess',
	      value: function onLoadSoundSuccess(response) {
	        console.log(response);
	      ...
	      value: function render() {
	        return React.createElement(
	          'div',
	          { id: 'track-list' },
	          React.createElement(TrackList, { tracks: this.state.tracks }),
	          React.createElement(SearchBox, { onSearch: this.onSearch.bind(this) }),
	          React.createElement(
	            'div',
	            null,
	            React.createElement(ResultsList, { loadSound: this.loadSound.bind(this), results: this.state.results })
	          )
	        );
	      }
	    }]);
	  ...
	  var TrackList = (function (_React$Component5) {
	    _inherits(TrackList, _React$Component5);

	    function TrackList() {
	      _classCallCheck(this, TrackList);

	      _get(Object.getPrototypeOf(TrackList.prototype), 'constructor', this).apply(this, arguments);
	    }
	      ...
	      value: function render() {
	        return React.createElement(
	          ...
	          this.props.tracks.map(function (track) {
	            return React.createElement(Track, { track: track, key: Math.random() });
	          })
	        );
	      }
	    }]);
	  ...
	  var Track = (function (_React$Component6) {
	    _inherits(Track, _React$Component6);
	  ...
	  ReactDOM.render(React.createElement(BeatBox, null), document.getElementById('beatbox'));
